...
# Inicializa los elementos y la billetera del cliente
customer = Customer(input("🤖 Por favor, dime tu nombre: "))
customer.wallet = Wallet()  # Inicializa la billetera del cliente
customer.wallet._init_()    # Inicializa la billetera del cliente

# Agrega elementos al vendedor
for i in range(10):
